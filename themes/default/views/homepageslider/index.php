...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        function image(n) {
            if (n !== null) {
                return '<div style="width:32px; margin: 0 auto;"><a href="<?=base_url();?>uploads/home-slider/'+n+'" class="open-image"><img src="<?=base_url();?>uploads/home-slider/thumbs/'+n+'" alt="" class="img-responsive"></a></div>';
            }
            return '';
        }
        ...
        var table = $('#catData').DataTable({
            ...
            'ajax' : { url: '<?=site_url('homepageslider/get_homepageslider');?>', type: 'POST', "data": function ( d ) {
