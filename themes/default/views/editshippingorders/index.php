...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        var table = $('#pcolorData').DataTable({
            ...
            'ajax' : { url: '<?=site_url('editshippingorders/get_editshippingorders');?>', type: 'POST', "data": function ( d ) {
        ...
        "buttons": [
            ...
            { "data": "purchased_id", "visible": false },
            { "data": "order_no", "visible": true },
            {
                "data": "useremail",
            ...
            },
            {
                ...
                "render": function(data, type, row) {
                    if (data == '1') {
                        return "<span style='color:#069;font-weight:600;'>Awaiting Shipping</span>";
                    } else if (data == '2') {
                        return "<span style='color:#036;font-weight:600;'>Awaiting Payment</span>";
                    } else {
                        return data; // Display the original value for other cases
                    }
                }
            },
                        ...
                        <table id="pcolorData" class="table table-bordered table-hover table-striped">
                            ...
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th style="max-width:30px;"><?= lang("Purchased ID"); ?></th>

                                    <th style="max-width:30px;"><?= lang("ORDER NUMBER"); ?></th>
