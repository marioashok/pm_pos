...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        function image(n) {
            if (n !== null) {
                return '<div style="width:32px; margin: 0 auto;"><a href="<?=base_url();?>uploads/categories/'+n+'" class="open-image"><img src="<?=base_url();?>uploads/categories/thumbs/'+n+'" alt="" class="img-responsive"></a></div>';
            }
            return '';
        }
    ...
    "render": function(data, type, row) {
        ...
        // Construct the URL with the 'id' as part of the 'name'
        var url = '<?=site_url('subcategories?category_id=')?>' + id;
