    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="col-lg-12">
                        <?php echo form_open_multipart("bandcolors/add", 'class="validation"'); ?>
                        <div class="row">
                            <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <?= form_submit('add_bandcolor', lang('add_bandcolor'), 'class="btn btn-primary"'); ?>
